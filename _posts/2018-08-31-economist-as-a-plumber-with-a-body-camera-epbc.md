---
title: "Economist as a plumber with a body camera (EPBC)"
date: 2018-08-31T17:09:11+00:00
slug: economist-as-a-plumber-with-a-body-camera-epbc
categories:
  - "Data & Python"
  - "Macroeconomics"
tags:
...
The EPBC therefore has two goals: 1) encouraging the showing of how results were obtained, and 2) more frequently revisiting past results. To contribute to achieving this, I’m publishing a series of <a href="https://www.dataquest.io/blog/jupyter-notebook-tutorial/" target="_blank" rel="noopener">jupyter notebooks</a> that show my recent attempts at working with public economic data using python. For future projects and blog posts, I’ll link to the new notebooks, and use the tag **EPBC (for economists as plumber with body camera)**. I’m not sure if this will work out, or be sustainable, but it’s an interesting idea and worth a try.
